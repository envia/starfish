...
> **verifiedAt**: 2026-08-27T01:52:56.294Z
...
|---|---|---|---|---|---|
| requiredSlots | 필수(hard) | 100 | 100 | 100 | ✅ |
| astBaseline | 필수(hard) | 100 | 100 | 100 | ✅ |
| wikiStructure | 필수(hard) | 100 | 0 | 100 | ✅ |
| mermaidSyntax | 필수(hard) | 100 | 100 | 100 | ✅ |
| grounding | 필수(hard) | drift 0 | 96 | 100 | ✅ |
| claimGrounding | 필수(hard) | contradiction 0 | 99 | 100 | ✅ |
| diagramAccuracy | 필수(hard) | 미지원 0 | 60 | 100 | ✅ |
| moduleFrPairing | 필수(hard) | 100 | 100 | 100 | ✅ |
| symbolCoverage | 소프트 | — | 5 | 5 | ⚠️ |
| packageCoverage | 소프트 | — | 0 | 0 | ⚠️ |
