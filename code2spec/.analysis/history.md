...
- **실행 일시**: 2026-08-27 10:13:32
- **code2spec 버전**: 0.5.2
- **실행 유형**: full
- **Coding assistants**: cline
- **History format**: v2 hybrid
- **분석 모드**: Detail
- **분석 대상**: `/home/hwang/work/E/starfish_`
...
|----------|------|------|----------|------|
| W1 | 10:13:41 | 10:13:53 | 12초 | ✅ |
| W2 | 10:29:44 | 10:45:53 | 16분 9초 | ✅ |
| W3 | 10:46:55 | - | 0초 | ⏳ |
| **총계** | | | **16분 21초** | |
...
| 메트릭 | 값 | 세부 |
|--------|------|------|
| Evidence Precision | 100.00% | 160/160 태그 유효 |
| Source Coverage | 100.00% | 330/330 파일 참조 |
| Core Coverage | 100.00% | 19/19 Core 모듈 카드 생성 |
| Broken Source Link Rate | 0.00% | 0/160 링크 깨짐 |
