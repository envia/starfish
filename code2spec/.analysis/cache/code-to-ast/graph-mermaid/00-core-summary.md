...
Generated from: `/home/hwang/work/E/starfish_`
Core modules: 20
...
graph TD
    ...
    f122["src/shell/Shell.cpp"]
    style f122 fill:#f96,stroke:#333,color:#fff
    f123["src/shell/Shell.h"]
    f124["src/shell/Window.h"]
    style f124 fill:#f96,stroke:#333,color:#fff
    f125["src/shell/dummy/WindowDummy.cpp"]
    f126["src/shell/efl/WindowEFL.cpp"]
    f127["src/shell/headless/WindowHeadless.cpp"]
    f128["src/shell/test/APIRecorderTest.cpp"]
    f129["src/shell/test/WebContainerTest.cpp"]
    f130["src/shell/test/WebViewTest.cpp"]
    f131["src/shell/x11_webcontainer/WindowX11Webcontainer.cpp"]
    f132["tool/lint/check_contract_abi.py"]
    f133["tool/repo_paths.py"]
    style f133 fill:#f96,stroke:#333,color:#fff
    f134["tool/runner/execution_test.py"]
    f135["tool/runner/execution_worker.py"]
    f136["tool/runner/test_runner.py"]
    f137["tool/runner/uwe_loader_test.py"]
    f138["tool/runner/uwe_worker_loader_test.py"]
    f139["tool/wpt/scripts/wpt_annotate.py"]
    f140["tool/wpt/scripts/wpt_audit.py"]
    f141["tool/wpt/scripts/wpt_manifest_lists.py"]
    f142["tool/wpt/scripts/wpt_reftest.py"]
    f143["tool/wpt/scripts/wpt_runner.py"]
    style f143 fill:#f96,stroke:#333,color:#fff
    f144["tool/wpt/scripts/wpt_server.py"]
    style f144 fill:#f96,stroke:#333,color:#fff
    f145["tool/wpt/scripts/wpt_status.py"]
    f0 -->|imports| f2
    f1 -->|imports| f2
    f3 -->|imports| f5
    f3 -->|imports| f1
