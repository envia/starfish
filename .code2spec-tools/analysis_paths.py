...
class AnalysisPaths(NamedTuple):
    ...
    @property
    def module_deps(self) -> Path:
        """Path to module-deps.json (direct, evidence-preserving module edges)."""
        return self.state_delta_dir / "module-deps.json"
...
KNOWN_FLAT_ARTIFACTS = {
    ...
    "module-deps.json": "state/delta/module-deps.json",
