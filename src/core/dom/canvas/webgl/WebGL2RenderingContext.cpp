    ...
    : WebGLRenderingContextBaseMixIn(canvasElement)
{
    ...
    GC_REGISTER_FINALIZER_NO_ORDER(
        this,
        [](void* obj, void* cd) {
            auto self = reinterpret_cast<WebGL2RenderingContext*>(obj);
...
void WebGL2RenderingContext::preInitialize(ScriptValue contextAttributes)
{
...
void WebGL2RenderingContext::initialize()
{
...
void WebGL2RenderingContext::onResize()
{
...
GLsizei WebGL2RenderingContext::drawingBufferWidth() const
{
    return m_canvasSurface->bufferWidth();
}

GLsizei WebGL2RenderingContext::drawingBufferHeight() const
{
...
String* WebGL2RenderingContext::drawingBufferColorSpace()
{
    return m_drawingBufferColorSpace;
}

void WebGL2RenderingContext::setDrawingBufferColorSpace(String* value)
{
...
String* WebGL2RenderingContext::unpackColorSpace()
{
    return m_unpackColorSpace;
}

void WebGL2RenderingContext::setUnpackColorSpace(String* value)
{
    if (isPredefinedColorSpace(value)) {
...
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::getExtension");
...
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::createBuffer");
    return nullptr;
    /*
...
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::createFramebuffer");
    return nullptr;
    /*
    ENTER_CONTEXT_SCOPE(nullptr);
...
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::createProgram");
    return nullptr;
    /*
    ENTER_CONTEXT_SCOPE(nullptr);
...
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::createRenderbuffer");
    return nullptr;
    /*
    ENTER_CONTEXT_SCOPE(nullptr);
...
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::createShader");
    return nullptr;
    /*
    ENTER_CONTEXT_SCOPE(nullptr);
...
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::createTexture");
    return nullptr;
    /*
    ENTER_CONTEXT_SCOPE(nullptr);
...
#define IMPLEMENT_DELETE_BUFFERS(Name, Deleter)                            \
    void WebGL2RenderingContext::delete##Name(Optional<WebGL##Name*> maybe) \
    {                                                                      \
        ENTER_CONTEXT_SCOPE();                                             \
        if (maybe.hasValue()) {                                            \
...
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::getUniform");
    return nullptr;
    /*
    ENTER_CONTEXT_SCOPE(nullptr);
...
void WebGL2RenderingContext::validateProgram(WebGLProgram* program)
{
    ...
    // If program was generated by a different WebGL2RenderingContext than this
...
#define IMPLEMENT_VERTEX_ATTRIB_NFV(N)                                      \
    void WebGL2RenderingContext::vertexAttrib##N##fv(GLuint index,           \
                                                    Float32List variant)    \
    {                                                                       \
        ENTER_CONTEXT_SCOPE();                                              \
...
void WebGL2RenderingContext::bufferSubData(GLenum target, GLintptr offset,
...
void WebGL2RenderingContext::handleTexImageWithArrayBufferView(
...
void WebGL2RenderingContext::handleTexImageWithImageSource(
...
#define IMPLEMENT_UNIFORM_NFV(N, Suffix, SrcType)                           \
    void WebGL2RenderingContext::uniform##N##Suffix(                         \
...
#define IMPLEMENT_UNIFORM_MATRIX_NFV(N)                                        \
    void WebGL2RenderingContext::uniformMatrix##N##fv(                          \
...
void WebGL2RenderingContext::setGLError(GLenum code, const char* message)
{
...
*/
bool WebGL2RenderingContext::hasGLError()
{
    updateGLError();
...
void WebGL2RenderingContext::updateGLError()
{
...
bool WebGL2RenderingContext::executeInContextScope(
...
WebGLRenderingContextState* WebGL2RenderingContext::getState()
{
    return m_state;
}

bool WebGL2RenderingContext::checkAttribOrUniformName(String* name)
{
...
bool WebGL2RenderingContext::isFromCurrentContext(WebGLObject* object)
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::isFromCurrentContext");
    return false;
    /*
...
bool WebGL2RenderingContext::isBoundCubeMapTexture(GLenum target)
{
...
bool WebGL2RenderingContext::isFromCurrentProgram(WebGLUniformLocation* location)
{
    // INDIGO_TODO
    STARFISH_UNIMPLEMENTED("INDIGO_WebGL2RenderingContext::isFromCurrentProgram");
    return false;
    /*
    ...
    if (location->program()->context() != this ||
        ...
        // If program were generated by a different WebGL2RenderingContext than
...
bool WebGL2RenderingContext::isExtensionEnabled(const char* name)
{
    const auto& iter = m_enabledExtensions.find(name);
    if (iter != m_enabledExtensions.end()) {
        return true;
...
bool WebGL2RenderingContext::isDefaultFramebufferBound()
{
    return !m_state->hasWebGLFramebuffer();
}

GLuint WebGL2RenderingContext::getCurrentFBO()
{
    return m_state->hasWebGLFramebuffer()
...
GLint WebGL2RenderingContext::getCurrentProgram()
{
    GLint program = 0;
...
void WebGL2RenderingContext::completePendingJobs()
{
    /*
        +---------+--------------+----------------------+---------------------+
...
void WebGL2RenderingContext::setPendingClearMask(uint32_t mask)
{
