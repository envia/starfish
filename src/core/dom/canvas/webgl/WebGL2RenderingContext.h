...
class WebGL2RenderingContext : public WebGLRenderingContextBaseMixIn {
public:
...
public:
    ...
    FILL_GC_POINTER(WebGL2RenderingContext, m_state);
    FILL_GC_POINTER(WebGL2RenderingContext, m_unpackColorSpace);
    FILL_GC_POINTER(WebGL2RenderingContext, m_drawingBufferColorSpace);
    FILL_GC_COLLECTION(WebGL2RenderingContext, m_enabledExtensions);
