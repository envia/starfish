...
public:
    ...
    /* Query Objects */
    WebGLQuery* createQuery(){ /* INDIGO_TODO */ return nullptr; }
    ...
    /* Sampler Objects */
    WebGLSampler* createSampler(){ /* INDIGO_TODO */ return nullptr; }
    ...
    /* Transform Feedback */
    WebGLTransformFeedback* createTransformFeedback(){ /* INDIGO_TODO */ return nullptr; }
    ...
    WebGLVertexArrayObject* createVertexArray(){ /* INDIGO_TODO */ return nullptr; }
