...
- [ ] **스펙 완전성** (이번 버그 범위 밖, §4.5 완전 구현):
  - [ ] definite-height 컬럼 컨테이너에서도 automatic minimum size 적용.
  - [ ] content size suggestion에 specified/transferred size suggestion + max main-size clamp.
